 ...
 * like map or alli.
 */
fn map_slices<A:Sized + Copy + Owned,B:Sized + Copy + Owned>(
    xs: &[A],
    f: &fn() -> ~fn(uint, v: &[A]) -> B)
    -> ~[B] {
...
pub fn map<A:Sized + Copy + Owned,B:Sized + Copy + Owned>(
...
pub fn mapi<A:Sized + Copy + Owned,B:Sized + Copy + Owned>(
        xs: &[A],
...
pub fn alli<A:Sized + Copy + Owned>(
    xs: &[A],
